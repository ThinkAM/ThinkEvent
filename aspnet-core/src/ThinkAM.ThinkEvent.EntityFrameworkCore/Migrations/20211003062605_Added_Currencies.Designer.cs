...
namespace ThinkAM.ThinkEvent.Migrations
{
    ...
    [Migration("20211003062605_Added_Currencies")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThinkAM.ThinkEvent.Currencies.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ThinkAM.ThinkEvent.Organizations.OrganizationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppOrganizationTypes");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ThinkAM.ThinkEvent.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ThinkAM.ThinkEvent.Authorization.Users.User", null)
                        .WithMany("Claims")
