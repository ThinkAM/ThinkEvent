...
{
    public abstract class ThinkEventWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ThinkEventWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ThinkEventWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ThinkEventDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ThinkEventDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ThinkEventDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ThinkEventDbContext, Task<T>> func)
        {
            T result;
